...
#author: Vineet Nayak S

#Program: Rock Paper Scissor without cheating
...
while(1):
    ...
    bit1=int(input("Player one, Enter the secret bit position"))#Player should enter the key_value from a dictionary
